...
def train(args):
    ...
    if args.ckpt_path is None:
        args.ckpt_path = args.model_path + "summ_checkpoints/" # save ckpt
    ...
    trainer = pl.Trainer(
        ...
        checkpoint_callback=True, progress_bar_refresh_rate=args.progress_bar_refresh_rate * args.acc_batch,
        precision=32,
