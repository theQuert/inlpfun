...
class PRIMERSummarizerLN(pl.LightningModule):
    ...
    def compute_rouge_batch(self, input_ids, output_ids, gold_str):
        ...
        for ref, pred in zip(gold_str, generated_str):
            ...
            preds.append(pred)
        path_file = os.path.join('/content/drive/MyDrive/MDS/wcep_custom/bs3_test/filtered_non/gen_summ_tuned', 
    ...
    def compute_rouge_all(self, outputs, output_file=None):
        ...
        # rouge_results.to_csv('/content/drive/MyDrive/MDS/wcep_custom/bs1_valid/filtered/gen_summ/rouge_result.csv')
